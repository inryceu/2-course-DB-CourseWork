...
import { ANALYTICS_USER_REGISTRATION_PROJECTION_REPOSITORY_TOKEN } from './application/contracts/analytics-user-registration-projection.repository';
...
import { ANALYTICS_PUBLIC_CONTRACT_TOKEN } from './contracts/api/analytics-public-contract';
